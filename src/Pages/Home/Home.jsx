  ...
  return (
    <>
      ...
      <div className="container mx-auto my-10 px-6 lg:px-[10%] py-10 space-y-24" >
        <h2 className='sm:text-[50px] lg:text-[65px] xs:text-[35px] text-nowrap font-bold leading-tight   '> Meet the leadership team. </h2>
      {TeamInfo.map((item, index) => {
        return (

          <LeaderShipComponent key={index} text1={item.text1} text2={item.text2} text3={item.text3} title={item.title} Subtitle={item.Subtitle} reverseLayout={index % 2 !== 0} img={item.img} />
